...
namespace EZPool
{
	...
	public abstract class PoolSO<T> : SerializedScriptableObject, IPool<T>
	{
		[AssetsOnly]
		...
		{
			return Instantiate(_prefab).GetComponent<T>();
		}
		...
		public virtual IEnumerable<T> Pop(int num = 1)
		{
		...
		public virtual void Push(T member)
		{
		...
		public virtual void Push(IEnumerable<T> members)
		{
