...
public class Managers : MonoBehaviour 
{
    ...
    InGameSpawnManger _inGameSpawnManger;
    ...
    public static InGameSpawnManger InGameSpawnManger { get => GetManager(Instance._inGameSpawnManger); set { Instance._inGameSpawnManger = value; } }
    public static FogOfWarManager FogOfWarManager { get => GetManager(Instance._fogOfWarManager); set { Instance._fogOfWarManager = value; } }
    ...
    public static ProductManager ProductManager => Instance._productManager;
