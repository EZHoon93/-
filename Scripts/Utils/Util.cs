...
public class Util
{
    ...
    public static T[] GetComponentsChildrenRemoveMy<T>(Transform go, bool recursive = false) where T : UnityEngine.Component
    {
        if (recursive)
        {
        ...
        else
        {
            ...
            {
                var componet = go.transform.GetChild(i).GetComponent<T>();
                result.Add(componet);
            }
