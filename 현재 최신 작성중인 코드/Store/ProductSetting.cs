...
public class ProductSetting : ScriptableObject
{
    ...
    [SerializeField] ProductData _avaters;
    ...
    public GameObject GetSkinByKey(Define.ProductType productType , string skinKey)
    {
        var skins = GetSkins(productType);
        return null;
    }
    ...
    public GameObject[] GetSkins(Define.ProductType productType)
    {
        switch (productType)
        {
            case Define.ProductType.Accessories:
                return accessories;
            case Define.ProductType.Avater:
    ...
    public GameObject GetSkinPrefab(Define.ProductType productType , int selectIndex, Transform parent = null)
    {
        var skinList = GetSkins(productType);
